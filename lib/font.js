...
const fontFamilies = {
  sans: [...(BLOG.CUSTOM_FONT ? BLOG.CUSTOM_FONT_SANS : []),
    '"Microsoft YaHei"', '-apple-system', '"Noto Sans SC"', '"PingFang SC"', 'BlinkMacSystemFont', '"Hiragino Sans GB"',
  ...
  serif: [...(BLOG.CUSTOM_FONT ? BLOG.CUSTOM_FONT_SERIF : []),
    '"Noto Serif SC"', '-apple-system', 'SimSun', '"Times New Roman"', 'Times', 'serif',
