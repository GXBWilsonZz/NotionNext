...
const BLOG = {
  ...
  CUSTOM_FONT_URL: ['https://npm.elemecdn.com/@openfonts/noto-sans-sc_chinese-simplified/index.css'], // 自定义字体的CSS
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-G456H50ZF7', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
